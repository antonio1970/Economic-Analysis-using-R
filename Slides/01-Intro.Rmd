...
author: Dr. Antonio Rodriguez Andres| Technical University of Ostrava
date: EAR #"`r format(Sys.time(), '%d %B %Y')`"
output:
...
4. [R for data science (bookdwon)](#r4ds)
...
Fill in the gaps left by traditional econometrics and methods classes using less flexible econometrics packages.
...
That's kind of abstract. Let's review each element in turn using our original plot call.

---

# 1. Aesthetic mappings

Here's our earlier ggplot2 code again:
...
Note that we can assign the aesthetic mappings in the geom layer too.
...
- Note that you don't have to touch your original data; ggplot2 takes care of all of that.
...
p2 =
  ...
  theme_bw() ## Try a black and white plot theme
```
