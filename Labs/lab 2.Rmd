...
```{r}
library(haven) # Not from R base. Package = haven
df_stata = read_dta("Stata File.dta") ## some Stata dataset
df_spss  = read_spss("SPSS File.sav") ## For instance the European Social Survey or General Social Survey
```

```{r}
library(readxl)
df_excel = read_excel("Excel Spreadsheet.xlsx")
```

RStudio Alternative: “File” Menu > “Import Dataset”
